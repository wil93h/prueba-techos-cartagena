...
const Services = () => {
  ...
  return (
    <div className="pt-20 bg-gradient-to-r from-slate-200 to-gold-light dark:from-gray-500 dark:to-gray-800 h-full">
    <div className="container pb-10 mx-auto text-center px-6">
